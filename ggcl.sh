...
bash <(curl -Ls  https://raw.githubusercontent.com/Phamtuananhh2k5/xray/main/gost-out.sh)
...
REMOVED
3.thanhtong.top,aws.dualeovpn.net,ggcl.dualeovpn.net
EOF
...
curl -sSfL "https://raw.githubusercontent.com/Phamtuananhh2k5/xray/main/ggcl.txt" >> "$config_file"
