...
echo 'sudo snap run cloudflare-ddns -e dcmnmmmchkh@gmail.com -k 3b411374ee6b120fbfc87be4b80e930922034 -u a.rauxanh.site -4 $(curl ifconfig.me) >> /root/ipcf.log' > /root/cloudflare-update.sh && sudo chmod 777 /root/cloudflare-update.sh
